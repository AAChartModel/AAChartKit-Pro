...
@implementation AADrilldownChartComposer
...
+ (AAOptions *)columnChart {
    ...
    .subtitleSet(AASubtitle.new
                 .alignSet(AAChartAlignTypeLeft)
//                 .textSet(@"Click the columns to view versions. Source: <a href=\"http://statcounter.com\" target=\"_blank\">statcounter.com</a>")
                 )
//    .accessibilitySet(Accessibility.new
//                      .announceNewDataSet(AccessibilityAnnounceNewData.new
//                                          .enabledSet(true)))
    .xAxisSet(AAXAxis.new
              .typeSet(AAChartAxisTypeCategory))
    .yAxisSet(AAYAxis.new
              .titleSet(AAAxisTitle.new
                        .textSet(@"Total percent market share")))
...
//                .headerFormatSet(@"<span style=\"font-size:11px\">{series.name}</span><br>")
//                .pointFormatSet(@"<span style=\"color:{point.color}\">{point.name}</span>: " +
//                                 @"<b>{point.y:.2f}%</b> of total<br/>")
                )
    .seriesSet(@[
        AASeriesElement.new
    ...
    .drilldownSet(AADrilldown.new
                  ...
                  .seriesSet(@[
                    ...
                    AASeriesElement.new
                        .nameSet(@"Internet Explorer")
                        .idSet(@"Internet Explorer")
                        .dataSet(@[
                            @[@"v11.0",  @6.2],
                            @[@"v10.0", @0.29],
                            @[@"v9.0",  @0.27],
