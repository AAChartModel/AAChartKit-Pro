...
AAPropSetFuncImplementation(AAXAxis, NSNumber *, maxPadding) //Padding of the max value relative to the length of the axis. A padding of 0.05 will make a 100px axis 5px longer. This is useful when you don't want the highest data value to appear on the edge of the plot area. When the axis' max option is set or a max extreme is set using axis.setExtremes(), the maxPadding will be ignored. Defaults to 0.01.
AAPropSetFuncImplementation(AAXAxis, NSNumber *, minPadding)  //Padding of the min value relative to the length of the axis. A padding of 0.05 will make a 100px axis 5px longer. This is useful when you don't want the lowest data value to appear on the edge of the plot area. 默认是：0.05.
...
AAPropSetFuncImplementation(AAXAxis, id,         showLastLabel) //是否显示最后一个刻度标签。在笛卡尔图表上默认为 true，在极坐标图表上默认为 false
