...
@class AAStyle, AAFilter, AATextPath;
...
@interface AAFilter : NSObject

AAPropStatementAndPropSetFuncStatement(copy,   AAFilter, NSString *, property)
AAPropStatementAndPropSetFuncStatement(copy,   AAFilter, NSString *, operator)
AAPropStatementAndPropSetFuncStatement(strong, AAFilter, NSNumber *, value)

@end


@interface AATextPath : NSObject

AAPropStatementAndPropSetFuncStatement(assign, AATextPath, BOOL          , enabled)
AAPropStatementAndPropSetFuncStatement(strong, AATextPath, NSDictionary *, attributes)
