...
AAPropStatementAndPropSetFuncStatement(assign, AASeries, id            , colorByPoint) //设置为 true 则是给每个点分配颜色。
AAPropStatementAndPropSetFuncStatement(assign, AASeries, BOOL ,          connectNulls) //设置折线是否断点重连 https://www.zhihu.com/question/24173311
...
AAPropStatementAndPropSetFuncStatement(strong, AASeries, NSNumber     *, pointPadding)
AAPropStatementAndPropSetFuncStatement(strong, AASeries, NSNumber     *, groupPadding)
